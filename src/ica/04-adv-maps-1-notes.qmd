...
mn_cities <- st_read("../../data/raw/04_adv_maps/shp_loc_pop_centers/city_and_township_population_centers.shp")
mn_water <- st_read("../../data/raw/04_adv_maps/shp_water_lakes_rivers/LakesAndRivers.shp")
```
