...
posts <- c(
  "This is a  post about R programming.",
  "I like data science!",
  "How many times does the letter 'a' appear?",
  "No vowels here: ttsk mmff"
)

str_count(posts, "a")

str_detect(posts, "data")

str_extract(posts, "\\b[aeiouAEIOU][a-zA-Z]+")

str_extract_all(posts, "[aeiouAEIOU]")

str_locate(posts, "[aeiouAEIOU]")

str_match(posts, "^([A-Za-z]+)")
